...
def _transform_policy_obs_left_right(env: ManagerBasedRLEnv, obs: torch.Tensor) -> torch.Tensor:
    ...
    for h in range(HISTORY_LEN):
        ...
        obs[:, start_idx:end_idx] = _switch_elf3_lite_joints_left_right(obs[:, start_idx:end_idx])
    # joint vel
    for h in range(HISTORY_LEN):
        start_idx = end_idx
    ...
    for h in range(HISTORY_LEN):
        ...
        obs[:, start_idx:end_idx] = _switch_elf3_lite_key_body_pos_left_right(obs[:, start_idx:end_idx])
...
def _transform_actions_left_right(actions: torch.Tensor) -> torch.Tensor:
    ...
    actions[:] = _switch_elf3_lite_joints_left_right(actions[:])
    return actions
...
"""
Lab joint names:
 0- l_shoulder_y_joint
 1- r_shoulder_y_joint
 2- waist_y_joint
 3- l_shoulder_x_joint
 4- r_shoulder_x_joint
 5- waist_x_joint
 6- l_shoulder_z_joint
 7- r_shoulder_z_joint
 8- waist_z_joint
 9- l_elbow_y_joint
10- r_elbow_y_joint
11- l_hip_y_joint
...
左侧关节 → 右侧关节 交换:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 0- l_shoulder_y_joint ↔  1- r_shoulder_y_joint
 3- l_shoulder_x_joint ↔  4- r_shoulder_x_joint
#  6- l_shoulder_z_joint ↔  7- r_shoulder_z_joint
 9- l_elbow_y_joint    ↔ 10- r_elbow_y_joint
11- l_hip_y_joint      ↔ 12- r_hip_y_joint
13- l_wrist_x_joint    ↔ 14- r_wrist_x_joint
15- l_hip_x_joint      ↔ 16- r_hip_x_joint
17- l_wrist_y_joint    ↔ 18- r_wrist_y_joint
# 19- l_hip_z_joint      ↔ 20- r_hip_z_joint
# 21- l_wrist_z_joint    ↔ 22- r_wrist_z_joint
23- l_knee_y_joint     ↔ 24- r_knee_y_joint
25- l_ankle_y_joint    ↔ 26- r_ankle_y_joint
27- l_ankle_x_joint    ↔ 28- r_ankle_x_joint
...
def _switch_elf3_lite_joints_left_right(joint_data: torch.Tensor) -> torch.Tensor:
    ...
    roll_indices = [3, 4, 13, 14, 15, 16, 27, 28]
    yaw_indices = [6, 7, 19, 20, 21, 22]
    ...
    joint_data_switched[..., [5, 8]] *= -1.0
    
    return joint_data_switched


def _switch_elf3_lite_key_body_pos_left_right(key_body_pos: torch.Tensor) -> torch.Tensor:
