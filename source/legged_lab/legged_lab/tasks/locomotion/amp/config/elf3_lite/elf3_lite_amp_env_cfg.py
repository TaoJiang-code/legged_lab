...
from legged_lab.assets.elf3 import ELF3LITE_CFG
...
class elf3_lite_AmpRewards():
    ...
    dof_pos_limits = RewTerm(
        ...
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_ankle_y_joint", ".*_ankle_x_joint"])},
    )
    ...
    joint_deviation_hip = RewTerm(
        ...
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_z_joint", ".*_hip_x_joint"])},
    )
...
#=========================================================================================#
    feet_air_time = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_ankle_x_link"),
            "threshold": 0.4,
        },
    )
    feet_slide = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=".*_ankle_x_link"),
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_ankle_x_link"),
        },
    )
...
@configclass
class elf3_lite_AmpEnvCfg(LocomotionAmpEnvCfg):
    """Configuration for the G1 AMP environment."""
    
    rewards: elf3_lite_AmpRewards = elf3_lite_AmpRewards()
    
    def __post_init__(self):
        super().__post_init__()
        
        self.scene.robot = ELF3LITE_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")

        # ------------------------------------------------------
        # motion data
        # ------------------------------------------------------
        self.motion_data.motion_dataset.motion_data_dir = os.path.join(
            LEGGED_LAB_ROOT_DIR, "data", "MotionData", "elf3_lite", "amp", "walk_and_run"
        )
...
@configclass
class elf3_lite_AmpEnvCfg_PLAY(elf3_lite_AmpEnvCfg):
